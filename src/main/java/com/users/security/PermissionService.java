...
public class PermissionService {
	...
	//retrieves an authentication token for username and password. displays context of the user and if they have authentication.
	...
	//Allows a profile to be edited only if the profile is that current user or an admin
